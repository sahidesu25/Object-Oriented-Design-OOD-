...
namespace XmlProcessing
{
 ...
 // inline std::vector<std::shared_ptr < AbstractXmlElement >>& AbstractXmlElement::children(){  }
  ...
  private:
    std::string text_;
	std::shared_ptr<AbstractXmlElement> parent;
  ...
  inline  std::vector<std::pair<std::string, std::string>>& TaggedElement::attributes(){ return attribs_; }
 ...
 inline  std::vector<std::pair<std::string, std::string>>& ProcInstrElement::attributes(){ return attribs_; }
  ...
  inline  std::vector<std::pair<std::string, std::string>>& XmlDeclarElement::attributes(){return attribs_; }
